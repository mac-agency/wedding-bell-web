...
$site_top = "https://wedding-bell-web.com/design1/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "info@mac-agency.com,web-admin@wedding-bell-web.com";
...
$re_subject = "ご返事を頂きましてありがとうございました";
...
御返事をいただきましてありがとうございました。

お寄せいただいた内容は以下の通りとなっています。
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://www.php-factory.net/" target="_blank">- 自動メールです -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
